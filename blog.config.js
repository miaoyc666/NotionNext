...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '747b78733f4f4be09704142723b2a1f0,en:747b78733f4f4be09704142723b2a1f0',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'miaoyc', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '边送外卖边搬砖🥹', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://happycode.fun', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'miaoyc的Notion博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'miaoyc1989@hotmail.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/miaoyc666', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '京ICP备2021007038号-3', // 备案号 闽ICP备XXXXXXX
  ...
  NOTION_PROPERTY_NAME: {
    ...
    icon: process.env.NEXT_PUBLIC_NOTION_PROPERTY_ICON || '/avatar.svg',
